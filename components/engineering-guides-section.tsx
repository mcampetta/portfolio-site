...
export function EngineeringGuidesSection({ item }: EngineeringGuideSectionProps) {
  return (
    <SectionShell
      ...
      copy="A smaller supporting section for technical explanation and process communication."
      compactTop
    >
      <div className="max-w-6xl border-t border-white/10 pt-10">
        <div className="grid gap-8 lg:grid-cols-[minmax(0,0.9fr)_minmax(320px,1.1fr)] lg:items-start lg:gap-12">
